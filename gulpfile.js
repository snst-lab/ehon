...
gulp.task(
	'debug',
	gulp.series('clean:build', 'compile:wasm', gulp.parallel('compile:ts', 'compile:sass'), 'browser:sync', 'watch')
);

gulp.task('build', gulp.series('clean:build', 'compile:wasm', gulp.parallel('compile:ts', 'compile:sass')));
